...
export const PetApiFetchParamCreactor = {
     ...
     */
    updatePetWithForm(params: {  petId: number; name?: string; status?: string; }): FetchArgs {
        // verify required parameter "petId" is set
        if (params["petId"] == null) {
...
export const PetApiFp = {
     ...
     * @param status Updated status of the pet
     */
    updatePetWithForm(params: { petId: number; name?: string; status?: string;  }): (fetch: FetchAPI, basePath?: string) => Promise<any> {
     ...
     * @param file file to upload
     */
    uploadFile(params: { petId: number; additionalMetadata?: string; file?: any;  }): (fetch: FetchAPI, basePath?: string) => Promise<ApiResponse> {
...
export const StoreApiFetchParamCreactor = {
     ...
     */
    deleteOrder(params: {  orderId: number; }): FetchArgs {
...
export const StoreApiFp = {
     ...
     * @param orderId ID of the order that needs to be deleted
     */
    deleteOrder(params: { orderId: number;  }): (fetch: FetchAPI, basePath?: string) => Promise<any> {
...
export class StoreApi extends BaseAPI {
     ...
     * @param orderId ID of the order that needs to be deleted
     */
    deleteOrder(params: {  orderId: number; }) {
