...
{ 
    ...
    { 
        ...
        [HttpGet]
        [Route("/lighting/switches/{deviceId}")]
        [ValidateModelState]
        ...
        /// <response code="200">response</response>
        [HttpPost]
        [Route("/lighting/dimmers/{deviceId}/{value}")]
        [ValidateModelState]
        ...
        /// <response code="200">response</response>
        [HttpPost]
        [Route("/lighting/dimmers/{deviceId}/{value}/timer/{timeunit}")]
        [ValidateModelState]
        ...
        /// <response code="200">response</response>
        [HttpPost]
        [Route("/lighting/switches/{deviceId}/{value}")]
        [ValidateModelState]
        ...
        /// <response code="200">response</response>
        [HttpPost]
        [Route("/lighting/switches/{deviceId}/{value}/timer/{minutes}")]
        [ValidateModelState]
