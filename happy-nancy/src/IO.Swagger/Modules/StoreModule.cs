...
using IO.Swagger.ponelatlots_of_comments1_0_0.Models;
using IO.Swagger.ponelatlots_of_comments1_0_0.Utils;
using NodaTime;

namespace IO.Swagger.ponelatlots_of_comments1_0_0.Modules
{ 
    ...
    public sealed class StoreModule : NancyModule
    {
        ...
        public StoreModule(StoreService service) : base("/ponelat/lots-of-comments/1.0.0")
        { 
